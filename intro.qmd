...
```{r fig-philipleysolvents, opts.label="marginfigure"}
#| fig-cap: "Philip Ley (1933--2015)<br>[Image Credit](https://www.sydney.edu.au/arms/archives/media/me_objects/7583)"
#| out-width: "250"
#| echo: false
knitr::include_graphics("images/Philip_Ley2.jpg")
```
