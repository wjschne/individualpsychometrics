...
:::{#fig-philipleysolvents .column-margin .float-start}

![](images/Philip_Ley3.jpg){width="200px"}

Philip Ley (1933--2015)<br>[Image Credit](https://www.sydney.edu.au/arms/archives/media/me_objects/7583)
:::

Whenever I go to a library, I find the book I need and then run my fingers over the books nearby that might also be interesting. Sometimes I see pretty much what I expect to find, but more often than not I go places I did know know were places to go. I like the idea of "wasting time" productively. I will read almost anything, even if it has no apparent value to me at the time, so long as it is the product of a disciplined mind trying to communicate clearly. From time to time, this pastime of casting a wide net pulled in some big surprises.
