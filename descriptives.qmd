...
```{r}
#| label: tbl-frequencydistributiontable
...
d |> 
  rename(Value = X,
         ...
         Proportion = p,
         `Cumulative\\\nProportion` = cp) |> 
  apa_flextable(font_family = bfont, table_width = 1) |> 
...
Let's start with a data set from @garciaWomensReactionsIngroup2010, which can accessed via the psych package. 
