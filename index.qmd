...
Throughout the book, I have used Matthew Butterick's [Equity](https://practicaltypography.com/equity.html) font family (specifically Equity Text A Tab). Equity is not free, but I was glad to pay for it in exchange for all I learned from Butterick's free online book, [*Practical Typography*](https://practicaltypography.com/). Equity was designed to fit in the same space as Times New Roman. If you need to render any figures but do not have access to Equity, then rendering with R's `serif` font (Times for Mac and Times New Roman for Windows) should provide similar results.
