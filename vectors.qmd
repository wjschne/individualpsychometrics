...
middle_axes(limits = c(0,5)) +
  ...
  ob_latex("\\vec{v}_1",
           height = .25,
           p1 + ob_polar(degree(135), .3),
           color = myfills[1]) +
  ob_latex("\\vec{v}_2",
           height = .25,
           p2 + ob_polar(degree(-45), .3),
           color = myfills[2]) +
  ob_latex(
    "{\\color[HTML]{51315E}\\vec{v}_3}={\\color[HTML]{27408B}\\vec{v}_1}+{\\color[HTML]{8B1A1A}\\vec{v}_2}",
    height = .25,
    p1 + p2 + ob_polar(degree(60), .3),
    color = myfills[3]
  ) +
  ob_segment(o, p1, arrow_head = my_arrowhead, resect_head = 2) +
  ob_segment(o, p2, arrow_head = my_arrowhead, resect_head = 2) +
  ob_segment(p1,
             p1 + p2,
             arrow_head = my_arrowhead,
             resect = 2,
  ...
  ob_segment(p2,
             ...
             resect = 2,
             linetype = "dashed") +
  ob_segment(o, p3, arrow_head = my_arrowhead, resect_head = 2)
